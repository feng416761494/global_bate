 ...
 * 描述：非本人在职证明
 */
public class JobProve1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_job_prove1);
        getWindow().addFlags(WindowManager.LayoutParams.FLAG_TRANSLUCENT_NAVIGATION);
        getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_ADJUST_RESIZE);
        ActivityManager.getInstance().addActivity(JobProve1Activity.this);
        initView();
        initData();
        toListener();
    ...
    protected void onDestroy() {
        ActivityManager.getInstance().removeActivity(JobProve1Activity.this);
        super.onDestroy();
    }
    ...
    private void connectWork() {
        if (Constants.connect) {
            ...
            ConstantsMethod.showTip(JobProve1Activity.this, "无网络连接");
        }
    }
    ...
    private void toListener() {
        ...
        tv_save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!et_fax.getText().toString().equals("") && !tv_jobTime.getText().toString().equals("")
                    ...
                    ConstantsMethod.showTip(JobProve1Activity.this, "信息不完整");
                }
            }
        });
        tv_cancel.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(JobProve1Activity.this, PaymentActivity.class);
        ...
        rl_jobTime.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dialog = new MyAlertDialog(JobProve1Activity.this)
                        .builder()
    ...
    private void timePicker() {
        //日期选择
        LayoutInflater inflater1 = LayoutInflater.from(JobProve1Activity.this);
        timepickerview = inflater1.inflate(R.layout.timepicker, null);
        ScreenInfo screenInfo1 = new ScreenInfo(JobProve1Activity.this);
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                switch (r.getError_code()) {
                                    case 0:
                                        ConstantsMethod.showTip(JobProve1Activity.this, "已发送邮件到您的常用邮箱");
                                        if (Constants.IS_PAY == 1) {
                                            updateStatus("2");
                                            Intent intent = new Intent(JobProve1Activity.this, PhotoSubmissionActivity.class);
                                            ...
                                            JobProve1Activity.this.sendBroadcast(intentReceiver);
                                            Intent intent = new Intent(JobProve1Activity.this, PaymentActivity.class);
                                            intent.putExtra("addOrder", getIntent().getParcelableExtra("addOrder"));
                                            intent.putExtra("order_id", getIntent().getIntExtra("order_id", 1));
                                            startActivity(intent);
