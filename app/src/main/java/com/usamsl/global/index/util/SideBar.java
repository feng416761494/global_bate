...
public class SideBar extends TextView {
    ...
    private void init(AttributeSet attrs) {
        if (attrs != null) {
            ...
            scaleWidth = ta.getDimensionPixelSize(R.styleable.SideBar_scaleWidth, dp(10));
            ta.recycle();
        }
