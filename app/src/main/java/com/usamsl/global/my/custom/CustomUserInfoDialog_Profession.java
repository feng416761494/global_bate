...
public class CustomUserInfoDialog_Profession extends Dialog implements View.OnClickListener{
    ...
    public CustomUserInfoDialog_Profession(Context context2) {
    ...
    private void setViews() {
        view = inflater.inflate(R.layout.custom_dialog_user_info, null);
        setContentView(view);
...
//        dialogWindow.setAttributes(lp);
        lsvDialogUserInfo.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent("USER_SELECT_PROFESSION");
                intent.putExtra("selectPosition",position);
                context.sendBroadcast(intent);
                CustomUserInfoDialog_Profession.this.dismiss();
            }
        });
    }
